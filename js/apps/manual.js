  ...
  function render(body) {
    ...
    if (NS.I18n && NS.I18n.get() === 'en') {
      body.innerHTML = '<div class="manual-title">NovaVista 2004 Manual</div>' +
        '<div class="manual-sub">Your PC is your empire. This guide covers progression, network raids and survival. · User: ' + Util.esc(s.profile.name) + '</div>' +
        '<div class="manual-h2">1 · Your first five actions</div><ol class="manual-steps">' +
        '<li>Open <b>MyNova</b> and post when a trend is active. Followers produce advertising revenue.</li>' +
        '<li>Put earnings in <b>Nova First Bank</b>; interest accumulates automatically.</li>' +
        '<li>Open the <b>Network Map</b>, connect, scan a reachable node, break its firewall and upload its data.</li>' +
        '<li>Sell stolen data in <b>My Files</b> before the drive fills up.</li><li>Check <b>NovaMail</b> and claim completed missions.</li></ol>' +
        ...
        '<div class="manual-h2">3 · Income and progression</div><div class="manual-p"><b>Bank:</b> compound interest. <b>MyNova:</b> followers and trends. <b>Network raids:</b> cash and data. <b>NovaClick:</b> impressions. <b>Botnet:</b> passive NovaCoins. <b>Market:</b> trade NovaCoins as their price changes.</div>' +
        '<div class="manual-tip"><b>TIP:</b> Income scales with hacker level, legacy and implants. Active raids provide the fastest early progress.</div>' +
        '<div class="manual-h2">4 · Network raids</div><div class="manual-p">Every raid has random nodes, modifiers and a secondary objective. Actions consume <b>energy</b> and create <b>trace</b>. At 100 trace you may escape; failure loses uncollected cash and data.</div>' +
        '<div class="manual-p"><span class="manual-kbd">scan</span> reveals details · <span class="manual-kbd">crack</span> attempts a firewall break · <span class="manual-kbd">exploit</span> uses a vulnerability · <span class="manual-kbd">bruteforce</span> guarantees progress at high cost · <span class="manual-kbd">upload</span> drains an open node.</div>' +
        '<div class="manual-p">Low-trace drains build a loot combo. Stealth, proxies and worms help you survive. A node is reachable only after clearing a connected parent.</div>' +
