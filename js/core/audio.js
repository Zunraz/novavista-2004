...
(function () {
  ...
  var S = {
    ...
    flip: function () { tone(260, 0.035, 'square', 0.09); tone(180, 0.05, 'square', 0.06, 0.02); },
    bump: function () { tone(680, 0.05, 'sine', 0.14, 0, 300); },
    kick: function () { tone(320, 0.06, 'square', 0.12); tone(170, 0.09, 'square', 0.1, 0.02, 200); },
    ding: function () { tone(1560, 0.12, 'sine', 0.1); tone(2090, 0.16, 'sine', 0.07, 0.06); },
    whoosh: function () { tone(500, 0.12, 'sawtooth', 0.07, 0, 1400); tone(900, 0.14, 'sawtooth', 0.06, 0.05, 900); },
    launch: function () { tone(220, 0.1, 'square', 0.08, 0, 300); tone(660, 0.14, 'square', 0.09, 0.08, 900); },
